...
public class Fase implements Serializable, Comparable<Fase> {
    ...
    public String SQLECon() {
        return "UPDATE idbl.temp_idbl set fase=" + Varios.entrecomillar(this.empresaCon) + " where fase=" + Varios.entrecomillar(this.id) + " and (puntos!='0' and puntos!='') and tipo_juridico='E';";
    }

    public String SQLESin() {
        return "UPDATE idbl.temp_idbl SET fase=" + Varios.entrecomillar(this.empresaSin) + " where fase=" + Varios.entrecomillar(this.id) + " and (puntos='0' or puntos='') and tipo_juridico='E';";
    }

    public String SQLPCon() {
        return "UPDATE idbl.temp_idbl set fase=" + Varios.entrecomillar(this.particularCon) + " where fase=" + Varios.entrecomillar(this.id) + " and (puntos!='0' and puntos!='') and tipo_juridico='P';";
    }

    public String SQLPSin() {
        return "UPDATE idbl.temp_idbl SET fase=" + Varios.entrecomillar(this.particularSin) + " where fase=" + Varios.entrecomillar(this.id) + " and (puntos='0' or puntos='') and tipo_juridico='P';";
    }
}
